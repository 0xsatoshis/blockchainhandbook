...
据外媒报道，一台具有4000个以上量子比特的量子计算机就能瓦解区块链。若有人能做出这样的量子计算机，就能解出并验证每笔交易，未来产生的所有加密货币都会被其垄断，加密货币的信任系统也将被瓦解。

> 现状

根据美国加密货币研究与工程中心的研究论文，只有包含 1500 个量子位的量子计算机才能执行这个算法。而谷歌新发布论文中的“量子霸权”机器仅包含 54 个量子位，暂时不太可能满足标准。要达到 1500 个量子位的标准可能还需要很多年。
